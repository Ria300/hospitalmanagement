...
<h1 style="font-family:courier;">CITY HOSPITAL</h1></div>
       ...
       <div class="bg-img">
  <form action="DoctorsignController" method="post" class="container">
      <center><img src="p1.png" width="70" height="70"> </center>
    <center><label><h3>DOCOTR'S SIGNUP</h3></label><br></center>
    <center><p>Please fill in this form to create an account.</p></center>
    <hr>
    
    <label for="did"><b>Doctor's Id</b></label>
    
    <input type="text" placeholder="Enter did" name="did" required>
...
<div class="clearfix">
    <button type="button" class="cancelbtn"><a href="doctorsignup.jsp">CANCEL</a></button>
