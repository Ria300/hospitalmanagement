...
<h1 style="font-family:courier;">CITY HOSPITAL</h1></div>
       ...
       <div class="bg-img">
           <br><br>
  <form action="PaybillController" method="post" class="container">
      <center><img src="p1.png" width="70" height="70"> </center>
    <center><label><h3>PAY BILL</h3></label><br></center>
...
<br><br><br>
<button type="submit" class="btn">Pay Bill</button><br><br>
  </form>
</div>
